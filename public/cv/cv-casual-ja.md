...
さまざまな問題のための一般的な解決策を見出すことに楽しさを感じることが多いです．
...
そのため，興味の方向性を聞かれた際にはだいたい「**理論と実装のどちらもやれるようになりたい**」と答えることが多いです．

とくに大目標を定めない (より過激には，定めるべきではないと思っている) タイプなので，具体的に取り組む領域はかなり変遷しています．

#### 具体的な興味

中学生・高校生ごろには主に機械学習に興味を持っており，
機械学習コンペ (後述) や数理最適化の勉強などをしていました．
...
- 2022 年 7月 - 2022年 9月 DENSO IT Laboratory
  - DNN を用いた超高解像度画像に対する異常検知の研究開発をしていました．
- 2023 年 3月 - 2023年 4月 株式会社サイカ
  - Julia 言語を用いたハイパフォーマンスな数理最適化ライブラリの開発をしていました．
- 2024 年 11月 - 2025年 5月 日本経済新聞社
  - LLM を用いたサービス開発のバックエンド開発や，データ分析コンペの作問・運営をしていました．

#### その他

- 2025年 Google Summer of Code 2025 ─ Development of a New Language Server for Julia
  - [Final Report](https://www.abap34.com/posts/gsoc2025_final_report.html)
- 2025年 Teaching Assistant: 関数型プログラミング基礎

### スキル

コンピュータサイエンス (とくにプログラミング言語処理系，静的プログラム解析，機械学習) に関する基本的な知識と10 年以上のプログラミング経験があります．

よく使うプログラミング言語は Julia, Python, C++, JavaScript, Scheme などですが，基本的に特定の言語に対する苦手意識などはあまりなく，必要に応じて新しい言語を学びながらプロジェクトを進めたいタイプです．

Git/GitHub や CI/CD，Docker などのコンテナ技術なども日常的に使用しています．

#### 専門分野に関連するもの

コンパイラに対する知識があります．具体的にはさまざまなプログラミング言語処理系をイチから作る能力があり，例えば
...
- 型解析や多段階計算などを備えたスライド記述言語 [abap34/ss](https://github.com/abap34/ss)
- 拡張 Markdown パーサ [abap34/almo](https://github.com/abap34/almo)

などを開発しています．

OS などのシステムソフトウェアに対する知識が必要な開発の経験もあります．
例えば
...
また，プログラミング言語理論に関する他の領域 (プログラム意味論，型システムなど) に対する入門的な知識もあります．

#### データサイエンス・機械学習・数理最適化に関連するもの

機械学習に対しても長く興味を持っています．

例えば，高校生のときには機械学習コンペディションにいくらか参加しており，

- 第 85 回日本循環器学会学術集会 における心筋梗塞の検出予測コンペで優勝 [solution](https://speakerdeck.com/chizuchizu/quan-guo-yi-liao-aikontesuto-2021-1st-place-solution)

したことがあります．

データ分析コンペの運営経験もあり，
大学のサークルにおいて立ち上げたコミュニティにおいて 5 回コンペティションを開催し，どのコンペティションも大きな問題なく終了することができました．

その準備のために BigQuery などを用いた大規模データの処理の経験もあります．

機械学習の基礎的な側面に対する基本的な知識もあり，
例えば

- 自動微分の理論と実装に関する 45 分の発表 [slide](https://speakerdeck.com/abap34/julia-tokyo-number-11-toku-juliadebu-kuzi-dong-wei-fen)
- 並列計算における乱数生成に関する発表 [slide](https://speakerdeck.com/abap34/bing-lie-hua-shi-dai-noluan-shu-sheng-cheng)
- 自作の深層学習フレームワークの開発経験 [abap34/JITrench.jl](https://github.com/abap34/JITrench.jl)
などがあります．

#### その他の細かいスキル

初歩的な Web 開発の経験があります．
React / Next.js を使った簡単なフロントエンド開発，FastAPI などを使った簡単なバックエンド開発の経験，
streamlit などを使った簡単なデータ分析アプリの開発の経験などがあります．
...
また，日常会話レベルの英語力があります．
具体的には，Google Summer of Code において国際的なチームでコミュニケーションをとりながら難度の高いプロジェクトを問題なく進めることができました．

### リーダシップをとった経験

所属するサークルにおいて，機械学習コンペに取り組むコミュニティを立ち上げ

- 5 回のコンペティションを開催し，うち 2 回は企業の協賛のもと開催
- 新入生教育のための資料とオンラインジャッジ・コンペプラットフォームの開発
...
それを解決するための手段として初心者講座や Starter Notebook といった機構を整備しました
その結果，最終的にどのコンペでもほぼ全員がコンペに複数回提出することを達成することができました．

具体的な取り組みなどは開催ブログとして共有し，後輩や他大学の学生などが参考にできるようにしています．

- 初年度の開催記録 [https://trap.jp/post/1918/](https://trap.jp/post/1918/)
- 開催経験から得られた知見をまとめたブログ [post](https://www.abap34.com/posts/community_competetion_tips.html)

lapisla-prover や almo においてもチーム開発で主導的な役割を果たしました．
