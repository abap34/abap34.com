...
メールもしくは Twitter の DM がもっとも連絡がつきやすいです．
...
- 5 回のコンペティション開催．うち 2 回は企業の協賛のもと開催
- 新入生教育のための講義 (約10時間) とオンラインジャッジ・コンペプラットフォームの開発

などを行いました．

- [[前半 2 年の取り組みをまとめたスライド]](https://speakerdeck.com/abap34/kaggle-ban-gadekirumade)
