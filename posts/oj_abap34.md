...
既存の OSS を使おうとも思ったのですが、デプロイの仕方や実行環境の追加の仕方を調べるのがあまり楽しくなさそうだたこと、
traPの認証との連携も面倒そうだったことから、自分で作った方が早いだろういう判断で作りました。
...
FastAPI です。 とくにジャッジ周りは非同期処理が多いんですが、FastAPI だとその辺がかなり簡単にかけてすごいな〜と思いました。
